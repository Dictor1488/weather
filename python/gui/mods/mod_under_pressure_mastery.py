...
_CACHE_VERSION = 2  # bumped from 1 to invalidate old cache (added history/viewMode)
...
class MasteryController(object):
    ...
    def __init__(self):
        ...
        self._markHistory   = {}   # tankID -> list of float (up to _MAX_HISTORY)
        self._lastKnownMark = {}   # tankID -> float
        self._saveRev       = 0
    ...
    def _captureCurrentMarkSample(self, forceAppend=False):
        """Read current MOE % and append to per-tank history if it changed."""
