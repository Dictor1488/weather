...
from gui.mods import initialized as _weather_init
from gui.mods import finalized as _weather_fini
...
def init(*args, **kwargs):
    g_playerEvents.onAccountBecomePlayer += _weather_onAccountBecomePlayer
    g_playerEvents.onAvatarBecomeNonPlayer += _weather_onBecomeNonPlayer
