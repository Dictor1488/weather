...
# WeatherPanel.swf лежить у res/gui/flash/WeatherPanel.swf.
# Для Loader/URLRequest шлях "gui/maps/..." перетворювався на
# res/gui/flash/gui/maps/... і картинки не знаходились.
# Тому для ресурсів клієнта/мода під res/gui/maps/... використовуємо ../maps/...
PRESET_PREVIEW = {
